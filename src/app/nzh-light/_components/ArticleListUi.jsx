...
import {articleList} from "@/app/nzh-light/_components/mock-data";
...
const contentFeedSimple = (topic) =>
  `https://play.nzherald.co.nz/pf/api/v3/content/fetch/content-feed-simple?query={%22searchBy%22:%22taxonomy.tags.slug%22,%22type%22:%22story%22,%22site%22:%22nzh%22,%22searchFor%22:%22${topic}%22}&_website=nzh`
async function getData(topic) {
  console.log('d256 contentFeedSimple(topic):', contentFeedSimple(topic))
  // return articleList
  const res = await fetch(contentFeedSimple(topic), {
    headers: {
